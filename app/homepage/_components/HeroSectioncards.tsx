...
export function HeroCard() {
  ...
  return (
    <section className="w-full bg-white text-black py-24 md:py-36 px-4 md:px-12 relative z-10">
      ...
      {/* Cards Grid */}
      <div className="w-full grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 px-4 md:px-12 mt-16 sm:mt-20 md:mt-28">
        {cards.map((item, index) => (
          <Card
            key={index}
            className="bg-white text-black shadow-lg transition-transform duration-300 hover:-translate-y-3"
          >
